...
/**
 * Created by hai on 2017/4/12.
 */

public class StatusBarUtil {

    public static final int DEFAULT_STATUS_BAR_ALPHA = 112;
    private static final int FAKE_STATUS_BAR_VIEW_ID = 0;//资源ID
    private static final int FAKE_TRANSLUCENT_VIEW_ID = 0;//资源ID
    ...
    public static void setStatusWrite(Activity activity) {
