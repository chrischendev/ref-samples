...
//    }
    ...
    public void nextTuple() {
        ...
        final String[] words = new String[]{"飞燕女", "燕山雪", "俏千金", "狐美人", "虎头怪"};
        ...
        kafkaUtils.setCallBack(new KafkaUtils.CallBack() {
            @Override
            public void receive(List<Object> objectList) {
                objectList.stream().forEach(obj->collector.emit(new Values(obj)));
            }
        });
        kafkaUtils.startConsume();
        */
    }
