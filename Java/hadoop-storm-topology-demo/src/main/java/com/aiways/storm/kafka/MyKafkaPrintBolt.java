...
public class MyKafkaPrintBolt extends BaseRichBolt {
    private static Logger LOG = LoggerFactory.getLogger(MyKafkaPrintBolt.class);
    ...
    public void execute(Tuple tuple) {
        ...
        LOG.info("数据打印: " + new Gson().toJson(userList));
