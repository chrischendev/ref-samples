...
public class DataWriteUtils {
    //String filePath="d:/temp_storm_file_01.txt";
    String filePath = "/tmp/temp_storm_file_01.txt";
    ...
    */
     ...
     * @param str
     */
    public void writeToTxtFile(String str) {
     ...
     * @param strList
     */
    public void batchWriteStrListToTxtFile(List<String> strList) {
