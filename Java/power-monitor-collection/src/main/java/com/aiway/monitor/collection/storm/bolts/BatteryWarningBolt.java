 ...
 * 添加电池故障预警数据
 */
public class BatteryWarningBolt extends BaseRichBolt {
    private static Logger LOG = LoggerFactory.getLogger(BatteryWarningBolt.class);
    ...
    public void execute(Tuple tuple) {
        ...
        //处理
        DataHandleProxy.get().addWaring(vehicleList);
