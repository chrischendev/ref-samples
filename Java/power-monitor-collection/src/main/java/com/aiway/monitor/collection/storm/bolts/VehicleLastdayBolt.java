 ...
 * 处理上一天最后一条监控数据
 */
public class VehicleLastdayBolt extends BaseRichBolt {
    private static Logger LOG = LoggerFactory.getLogger(VehicleLastdayBolt.class);
    ...
    public void execute(Tuple tuple) {
        ...
        //处理
        DataHandleProxy.get().processVehicleLastDay(vehicleList);
