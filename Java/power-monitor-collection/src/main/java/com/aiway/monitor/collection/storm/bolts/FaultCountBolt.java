 ...
 * 处理故障统计数据
 */
public class FaultCountBolt extends BaseRichBolt {
    private static Logger LOG = LoggerFactory.getLogger(FaultCountBolt.class);
    ...
    public void execute(Tuple tuple) {
        ...
        //处理
        DataHandleProxy.get().processFaultCountData(vehicleList);
