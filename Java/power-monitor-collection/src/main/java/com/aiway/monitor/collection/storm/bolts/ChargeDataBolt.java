 ...
 * 处理充电数据
 */
public class ChargeDataBolt extends BaseRichBolt {
    private static Logger LOG = LoggerFactory.getLogger(ChargeDataBolt.class);
    ...
    public void execute(Tuple tuple) {
        ...
        //处理
        DataHandleProxy.get().processChargeData(vehicleList);
